...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2015 at 03:48 PM
...
--
ALTER TABLE `cts_commentdetails`
  MODIFY `cts_commentID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT for table `cts_replydetails`
--
ALTER TABLE `cts_replydetails`
  MODIFY `cts_replyID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `cts_taskinfo`
--
ALTER TABLE `cts_taskinfo`
  MODIFY `cts_taskID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
